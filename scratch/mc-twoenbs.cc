...
static ns3::GlobalValue g_outPath ("outPath",
                                   ...
                                   ns3::StringValue ("./1/"), ns3::MakeStringChecker ());
...
main (int argc, char *argv[])
{
  ...
  uePositionAlloc->Add (Vector (ueInitialPosition, -5, 70));
  ...
  ueNodes.Get (0)->GetObject<MobilityModel> ()->SetPosition (Vector (ueInitialPosition, -5, 70));
